...
<head>
    <meta charset="utf-8" />
    <title>Reset Password | Leadforms</title>
...
<body id="kt_body" class="header-fixed header-mobile-fixed subheader-enabled subheader-fixed aside-enabled aside-fixed aside-minimize-hoverable page-loading">
                        ...
                        <div class="login-form login-signin py-11">
                            ...
                            <form class="form" action="" method="post"  id="kt_login_signin_form">
                                ...
                                <div class="form-group">
                                    ...
                                    <input class="form-control form-control-solid h-auto py-3 px-4 " type="password" name="password" placeholder="Password" required="" value="" autocomplete="off">
                                </div>
                                ...
                                <div class="text-center pt-2">
                                    <button type="submit" class="btn btn-dark font-weight-bolder font-size-h6 px-8 py-4 my-3">Submit</button>
                                </div>
                                <!--begin::Action-->
    ...
    <?php if (isset($validation) || session('error')) : ?>
        <script>
            showFire('error', "Something Went Wrong. Please try again.");
        </script>
    <?php endif; ?>
    <!--end::Page Scripts-->
</body>
