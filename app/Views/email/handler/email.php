                                                ...
                                                <tbody>
                                                    ...
                                                    <tr>
                                                        <td
                                                            ...
                                                            <strong>Dear <?= ucwords(trim($name??'Sir/Mam')); ?>,</strong>
                                                            <p>Greetings from Suresh Gyan Vihar University! Jaipur</p>
                                                            <br>
                                                            <p>We are glad to inform you that you have successfully registered as a Carrier Counsling Associate.</p>
                                                            <p>Your credentials for  the upcoming session <?= session('year')??'2022' ?>-<?= (session('year')??'2022')+1 ?>, are given below wherein you need to login as a User</p>
                                                                <h3 style="margin-bottom: 5px;">Your Login Credentials:</h3>
                                                                <p style="margin: 5px auto;"><b>URL:</b> <a href="<?= base_url()?>" target="_blank"><?= base_url() ?></a></p>
                                                                <p style="margin: 5px auto;"><b>Session:</b> <?= session('year')??'2022' ?></p>
                                                                <p style="margin: 5px auto;"><b>Username:</b> <?= $sid ?></p>
                                                                <p style="margin: 5px auto;"><b>Password:</b> <?= $password ?></p>
                                                              
                                                            <p><a href="<?= base_url()?>" target="_blank"><b>Click
                                                                        here</b></a>&nbsp;to log in to your
                                                                <strong>CMP</strong> dashboard and submit the
                                                                your application form.
                                                            </p>
                                                            <p>In case you find any difficulty or face any problem while
                                                                accessing the portal, you may contact us over the phone
                                                                or by email. (Ignore if already done)</p>
                                                            <p><br><strong>Regards,</strong><br>Division of
                                                                Admission,<br>Suresh Gyan Vihar University</p>
                                                        </td>
                                                    </tr>
