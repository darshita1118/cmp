                ...
                <div class="wizard-steps mx-auto d-flex flex-row flex-md-row">
                    ...
                    <div class="wizard-step flex-grow-1 flex-basis-0">
                        <div class="wizard-wrapper pr-lg-7 pr-2">
                            ...
                            <div class="wizard-label mr-3">
                                <h3 class="wizard-title"><a href="<?= base_url($route.$lid.'/'.$sid.'/'.$slug.'/personal') ?>">Personal Details</a></h3>
                            </div>
                            <span class="svg-icon">
                    ...
                    <div class="wizard-step flex-grow-1 flex-basis-0">
                        <div class="wizard-wrapper pr-lg-7 pr-2">
                            ...
                            <div class="wizard-label mr-3">
                                <h3 class="wizard-title" ><a href="<?= base_url($route.$lid.'/'.$sid.'/'.$slug.'/parent') ?>" >Parent's Details</a></h3>
                    ...
                    <div class="wizard-step flex-grow-1 flex-basis-0">
                        <div class="wizard-wrapper">
                            ...
                            <div class="wizard-label">
                                <h3 class="wizard-title"><a href="<?= base_url($route.$lid.'/'.$sid.'/'.$slug.'/address') ?>">Residential Address</a></h3>
