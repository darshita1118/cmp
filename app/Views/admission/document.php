                    ...
                    <div class="row mb-3 ">
                        ...
                        <div class="col-xl-5">
                            ...
                            <div class="form-group">
                                ...
                                <select name="document_type" id="document_type" onChange="typeChange(this.value);" class="form-select">
                        ...
                        <div class="col-xl-5">
                            ...
                            <div class="form-group">
                                ...
                                <input type="file" id="document" class="form-control" name="document" accept="image/jpeg,image/gif,image/png" />
