                        ...
                        <div class="card-toolbar">
                            <ul class="nav nav-tabs nav-tabs-space-lg nav-tabs-line nav-tabs-bold nav-tabs-line-3x"
                                ...
                                <li class="nav-item mr-2">
                                    <a class="nav-link mx-0" target="_blank"  href="<?= base_url($controller.'/'.'print/'.$lid.'/'.$sid) ?>">
                                        <span class="nav-icon">
                                            <span class="svg-icon">
                                ...
                                <form class="form">
                                    ...
                                    <div class="row mx-0">
                                        ...
                                        <div class="col-lg-10 row mx-0 order-md-2 order-lg-1 order-xl-1">
                                            ...
                                            <div class="form-group col-lg-4">
                                                ...
                                                <input disabled type="text" id="cat" name="cat"
                                                    class="form-control form-control-solid" placeholder="Category" value="<?= $studentCategory ?>"
                                                    required="">

                                            </div>
                                            <div class="form-group col-lg-4">
                                                <label for="religion">Religions:</label>
                                                <input disabled type="text" id="religion" name="religion"
                                                    class="form-control form-control-solid" placeholder="Religions" value="<?= $studentReligion; ?>"
                                                    required="">

                                            </div>
                                            <div class="form-group col-lg-4">
                                                <label for="religion"><?= $other['id_name']??'' ?>.:</label>
                                                <input disabled type="text" id="aadhar" name="aadhar"
                                                    class="form-control form-control-solid" value="<?= $other['sip_no']??''; ?>"
                                                    required="">
                                    ...
                                    <div class="col-lg-12 row mx-0 order-md-2">
                                        ...
                                        <div class="form-group col-lg-3">
                                                ...
                                                <input readonly type="text" id="program" name="program"
                                                    class="form-control form-control-solid" placeholder="Program name" value="<?= $studentProgram; ?>"
                                                    required="">
                                    ...
                                    <div class="row mx-0">
                                        ...
                                        <div class="form-group col-lg-3">
                                            ...
                                            <input disabled type="text" id="father_name" name="father_name"
                                                class="form-control form-control-solid" value="<?= $parentDetail['father_name']??''; ?>" placeholder="Father Name">

                                        </div>
                                        <div class="form-group col-lg-3">
                                            <label for="mother_name">Mother Name:</label>
                                            <input disabled type="text" id="mother_name" name="mother_name"
                                        ...
                                        <div class="form-group col-lg-3">
                                            ...
                                            <input disabled type="text" id="parent_mobile" name="parent_mobile"
                                        ...
                                        <div class="form-group col-lg-3">
                                            ...
                                            <input disabled type="text" id="parent_email" name="parent_email"
                                        ...
                                        <div class="form-group col-lg-3">
                                            ...
                                            <input disabled type="text" id="father_income" name="father_income"
                                        ...
                                        <div class="form-group col-lg-3">
                                            ...
                                            <input disabled type="text" id="mother_income" name="mother_income"
                                        ...
                                        <div class="form-group col-lg-3">
                                            ...
                                            <input disabled type="text" id="landline" name="landline"
                                    ...
                                    <div class="row mx-0">
                                        ...
                                        <div class="col-lg-2">
                                            ...
                                            <div class="form-group mb-4">
                                                <label>State</label>
                                                <input disabled type="text" id="state" name="state"
                                                    value="<?= $row['state']??''; ?>"
                                                    class="form-control form-control-solid form-control-lg"
                                                    placeholder="State">
                                            </div>
                                        ...
                                        <div class="col-lg-2">
                                            ...
                                            <div class="form-group mb-4">
                                                ...
                                                <input disabled type="text" id="district" name="district"
                                                    value="<?= $row['district']??''; ?>"
                                                    class="form-control form-control-solid form-control-lg"
