            ...
            <div class="row">
                ...
                <div class="col-xl-3">
                    ...
                    <div class="form-group mb-4">
                        ...
                        <input disabled type="text" id="discipline" class="form-control form-control-solid form-control-lg" name="discipline" value="<?= $studentDepartment??''; ?>" placeholder="Discipline" />
                    </div>
                    <!--end::Select-->
                </div>
                <div class="col-xl-3">
                    ...
                    <div class="form-group mb-4">
                        ...
                        <input disabled type="text" id="program" class="form-control form-control-solid form-control-lg" name="program" value="<?= $studentProgram??''; ?>" placeholder="Program" />
                    </div>
                    <!--end::Select-->
                </div>
                <div class="col-xl-4">
            ...
            <div class="row">
                ...
                <div class="col-lg-3">
                    <div class="form-group mb-4 fv-plugins-icon-container">
                        ...
                        <input disabled type="text" id="religion" name="religion" value="<?= $studentReligion; ?>" class="form-control form-control-solid form-control-lg" placeholder="Hindu">
                    </div>
                </div>
                <div class="col-lg-3">
                    <div class="form-group mb-4 fv-plugins-icon-container">
                        ...
                        <input disabled type="text" id="cat" name="cat" value="<?= $studentCaste ?>" class="form-control form-control-solid form-control-lg" placeholder="OBC">
