...
$levels = $elModel->select(['el_id', 'el_name'])->whereIn('el_id', json_decode($courseInfo['validation_level'] ?? ''))->where('el_status', 1)->orderBy('prority', 'ASC')->findAll() ?? [];

$academicModel = new ApplicationModel('student_education_' . session('year'), 'se_id', 'sso_' . session('suffix'));
$row = $academicModel->where('sid', $sid)->orderBy('education_level', 'ASC')->findAll() ?? [];
...
<div id="academic" class="form-step fade active show">
    <div class="card border-0 mb-4 pb-3">
        ...
        <div class="card-body p-3 text-dark fw-bold border-bottom pb-4">
            <div class=" p-md-3">
                <form id="kt_forms" action="<?= base_url($actionUrl . $lid . '/' . $sid) ?>" novalidate="novalidate" method="POST">
                    ...
                    <div class="pb-5">
                        ...
                        foreach ($levels as $lev) : $i = $lev['el_id'];
                            ...
                            <div class="mb-4 d-flex mt-8">
                                <h5 class=" mr-2"><?= $lev['el_name']; ?> Details</h5>
                                <?php if (count($levels) == $count) { ?>
                                    <div>
                                        <input class="m-1" id="awaited" name="awaited" type="checkbox" onclick="Rawaited('<?= $i ?>');">
                                        <label for="awaited">Result Awaited</label>
                                    </div>
                            ...
                            if (in_array($lev['el_id'], array_column($row, 'education_level')) !== false) :
                                ...
                                <div class="form-group row m-2" id="awaited<?= $i ?>">
                                    ...
                                    <div class="col-lg-4 col-xl-4 px-2 mb-3">
                                        <input class="form-control " name="board<?= $i; ?>" id="board<?= $i; ?>" type="text" placeholder="Board/University" value="<?= old("board$i") ?? ($row[$key]['board_university'] ?? '') ?>" required />
                                    ...
                                    <div class="col-lg-4 col-xl-4 px-2 mb-3">
                                        <input class="form-control " name="inst_name<?= $i; ?>" id="inst_name<?= $i; ?>" type="text" placeholder="Institute/School Name" value="<?= old("inst_name$i") ?? ($row[$key]['institute_school'] ?? '') ?>" required />
                                    ...
                                    <div class="col-lg-4 col-xl-4 px-2 mb-3">
                                        <input class="form-control " name="year<?= $i; ?>" id="year<?= $i; ?>" type="text" placeholder="Passing Year" value="<?= old("year$i") ?? ($row[$key]['year'] ?? '') ?>" required />
                                    ...
                                    <div class="col-lg-4 col-xl-4 px-2 mb-3">
                                        <input class="form-control " name="max_marks<?= $i; ?>" id="max_marks<?= $i; ?>" type="text" placeholder="Max Marks" value="<?= old("max_marks$i") ?? ($row[$key]['total_marks'] ?? '') ?>" required />
                                    ...
                                    <div class="col-lg-4 col-xl-4 px-2 mb-3">
                                        <input class="form-control " name="obtained<?= $i; ?>" id="obtained<?= $i; ?>" type="text" placeholder="Obtained Marks" value="<?= old("obtained$i") ?? ($row[$key]['obtain_marks'] ?? '') ?>" required />
                                    ...
                                    <div class="col-lg-4 col-xl-4 px-2 mb-3">
                                        <select name="resulttype<?= $i; ?>" id="resulttype<?= $i; ?>" class="form-select">
                                    ...
                                    <div class="col-lg-4 col-xl-4 px-2 mb-3">
                                        <input class="form-control " name="percentage<?= $i; ?>" id="percentage<?= $i; ?>" type="text" placeholder="Percentage/Grade" value="<?= old("percentage$i") ?? ($row[$key]['grade_precentage'] ?? '') ?>" required />
                            ...
                            ?>
                                ...
                                <div class="form-group row m-2" id="awaited<?= $i ?>">
                                    ...
                                    <label class="col-xl-2 col-lg-2 col-form-label px-2 mb-3" for="board<?= $i; ?>">Board/University</label>
                                    <div class="col-lg-4 col-xl-4 px-2 mb-3">
                                        <input class="form-control " name="board<?= $i; ?>" id="board<?= $i; ?>" type="text" placeholder="Board/University" value="<?= old("board$i") ?>" required />
                                    </div>

                                    <label class="col-xl-2 col-lg-2 col-form-label px-2 mb-3" for="inst_name<?= $i; ?>">Institute/School Name</label>
                                    <div class="col-lg-4 col-xl-4 px-2 mb-3">
                                        <input class="form-control " name="inst_name<?= $i; ?>" id="inst_name<?= $i; ?>" type="text" placeholder="Institute/School Name" value="<?= old("inst_name$i") ?>" required />
                                    </div>
                                    <label class="col-xl-2 col-lg-2 col-form-label px-2 mb-3" for="year<?= $i; ?>">Passing Year</label>
                                    <div class="col-lg-4 col-xl-4 px-2 mb-3">
                                        <input class="form-control " name="year<?= $i; ?>" id="year<?= $i; ?>" type="text" placeholder="Passing Year" value="<?= old("year$i") ?>" required />
                                    </div>
                                    <label class="col-xl-2 col-lg-2 col-form-label px-2 mb-3" for="max_marks<?= $i; ?>">Max Marks</label>
                                    <div class="col-lg-4 col-xl-4 px-2 mb-3">
                                        <input class="form-control " name="max_marks<?= $i; ?>" id="max_marks<?= $i; ?>" type="text" placeholder="Max Marks" value="<?= old("max_marks$i") ?>" required />
                                    </div>

                                    <label class="col-xl-2 col-lg-2 col-form-label px-2 mb-3" for="obtained<?= $i; ?>">Obtained Marks</label>
                                    <div class="col-lg-4 col-xl-4 px-2 mb-3">
                                        <input class="form-control " name="obtained<?= $i; ?>" id="obtained<?= $i; ?>" type="text" placeholder="Obtained Marks" value="<?= old("obtained$i") ?>" required />
                                    </div>
                                    <label class="col-xl-2 col-lg-2 col-form-label px-2 mb-3" for="resulttype<?= $i; ?>">Result Type</label>
                                    <div class="col-lg-4 col-xl-4 px-2 mb-3">
                                        <select name="resulttype<?= $i; ?>" id="resulttype<?= $i; ?>" class="form-select">
                                    ...
                                    <label class="col-xl-2 col-lg-2 col-form-label px-2 mb-3" for="percentage<?= $i; ?>">Percentage/Grade</label>
                                    <div class="col-lg-4 col-xl-4 px-2 mb-3">
                                        <input class="form-control " name="percentage<?= $i; ?>" id="percentage<?= $i; ?>" type="text" placeholder="Percentage/Grade" value="<?= old("percentage$i") ?>" required />
                                    </div>
                                </div>
                                <input type="hidden" name="education_level<?= $i; ?>" value="<?= $i; ?>">
                            <?php endif; ?>
...
<script>
    function Rawaited(id) {
        //console.log(id);
        if ($('#awaited').is(":checked"))
            $("#awaited" + id).hide();
        else
            $("#awaited" + id).show();
    }

    <?php if (old('awaited') == 'on') { ?>
        $("#awaited").attr("checked", true);
        Rawaited('<?= count($levels) ?>');

    <?php } elseif (count($levels) - 1 == count($row)) { ?>
        $("#awaited").attr("checked", true);
        Rawaited('<?= count($levels) ?>');
    <?php } else { ?>
