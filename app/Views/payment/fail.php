                                ...
                                <div class="card-px text-center py-20 my-10">
                                    ...
                                    <div>
                                        ...
                                        <img style="width: 150px;"
                                            src="<?= base_url()?>/assets/media/error/billerror.png" alt="">

                                    </div>

                                    <h2 class="fs-2x font-weight-bolder mb-3">Fail!</h2>

                                    <!--end::Title-->

                                    <!--begin::Description-->

                                    <p class="text-gray-400 fs-4 fw-bold mb-10">Your payment is fail.<br> Your
                                    ...
                                    <!--begin::Action-->
                                    <?= "<a href='{$redirectUrl}' class='btn btn-primary'>Retry Payment</a>" ?>
                                    <!--end::Action-->
                                </div>
                                <!--end::Wrapper-->
                            </div>
