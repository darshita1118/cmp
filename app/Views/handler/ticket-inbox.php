                            ...
                            <table class="table table-head-custom table-head-bg table-borderless table-vertical-center">
                                ...
                                <tbody>
                                    ...
                                    <?php foreach ($tickets as $ticket) { ?>
                                        <tr class="border-bottom tr-hover <?= (@$ticket['read_status'] == 1) ? 'read' : 'unread' ?> " onclick="window.location.href='<?= base_url('handler/tickets/' . $ticket['token_id'] . '?step=inbox') ?>'">

                                            <td class="px-3 py-1">
                                                <div class="text-dark-75 d-block font-size-lg">
                                                    <span class="label label-light-info font-weight-bold ml-1 label-inline"><?= (isset($ticket['type'])) ? (($ticket['type'] == 0) ? '<b>To</b>/<del>CC</del>/<del>Transferred</del>' : '<b>CC</b>/<del>To</del>/<del>Transferred</del>') : '<b>Transferred</b>/<del>To</del>/<del>CC</del>' ?></span><br>
