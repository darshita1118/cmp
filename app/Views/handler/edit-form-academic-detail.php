...
<div class="px-4 py-2">
    <form id="kt_forms" action="<?= base_url('handler/edit-profile-step-action/'.$lid.'/'.$sid) ?>" novalidate="novalidate" method="POST">
        ...
        <div class="d-flex justify-content-between border-top mt-5 pt-5">
            <div class="mr-2">
                <a href="<?= base_url('handler/edit-application-form/' . $lid . '/' . $sid . '/profile-detail') ?>" class="btn btn-light-primary font-weight-bolder text-uppercase">Previous</a>
            </div>
            <div>
