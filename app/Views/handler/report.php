                    ...
                    <div class="offcanvas offcanvas-top ps-5 pe-5" tabindex="-1" id="offcanvasTop" aria-labelledby="offcanvasTopLabel">
                        ...
                        <div class="offcanvas-body mt-md-3">
                            ...
                            <form action="" class="row">
                                <div class="col-md-3">
                                    <div class="mb-3"><label class="form-label">From</label>
                                ...
                                <div class="col-md-3">
                                    <div class="mb-3">
                                        ...
                                        <select class="form-select" name="status[]" id="status" multiple>
                                ...
                                <div class="col-md-3">
                                    <div class="mb-3">
                                        ...
                                        <select name="program[]" id="program" class="form-select" multiple><?php foreach ($programs as $program) : ?>
