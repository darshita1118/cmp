...
<head>
    ...
    <meta name="description" content="SGVU Admission" />
...
<body id="kt_body" class="header-fixed header-mobile-fixed subheader-enabled subheader-fixed aside-enabled aside-fixed aside-minimize-hoverable page-loading">
                        ...
                        <div class="login-form login-signin py-11">
                            ...
                            <form class="form" action="" method="post" novalidate="novalidate" id="kt_login_signin_form">
                                ...
                                <div class="form-group">
                                    ...
                                    <input class="form-control form-control-solid h-auto py-3 px-4 " type="email" name="email" placeholder="Email" required value="" autocomplete="on" />
                                </div>
                                <!--end::Form group-->
    ...
    <script>
        document.getElementById('b3').onclick = function(){
            Swal.fire({
							text: "Password link has been sent on your email.",
							icon: "success",
