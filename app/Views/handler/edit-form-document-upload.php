...
<div class="px-4 py-2">
    ...
    <form class="form" action="<?= base_url('handler/edit-profile-step-action/'.$lid.'/'.$sid) ?>" method="post">
        <?= csrf_field() ?>
        <!--begin::Wizard Actions-->
        <div class="d-flex justify-content-between border-top mt-5 pt-5">
            <div class="mr-2">
                <a href="<?= base_url('handler/edit-application-form/' . $lid . '/' . $sid . '/academic-detail') ?>" class="btn btn-light-primary font-weight-bolder text-uppercase">Previous</a>
            </div>
            <div>
                <?php
