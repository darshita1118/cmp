                                ...
                                <form class="form">
                                            ...
                                            <div class="col-lg-2 col-xl-2 text-center">
                                                <div class="image-input image-input-outline image-input-circle">
                                                    <div class="image-input-wrapper"
                                                        style="background-image: url('//<?= $url.substr($photoUrl,1) ?>')">
                                                    </div>
                                        ...
                                        <div class="col-lg-10 row mx-0 order-md-2 order-lg-1 order-xl-1">
                                            <div class="form-group col-lg-4">
                                                ...
                                                <input readonly type="text" id="name" name="name"
                                                    class="form-control form-control-solid" value="<?= ucwords(trim($sidInfo['si_first_name'].' '.$sidInfo['si_middle_name'].' '.$sidInfo['si_last_name'])); ?>" placeholder="Name"
                                                    required="">
                                            ...
                                            <div class="form-group col-lg-4">
                                                ...
                                                <input readonly type="text"
                                                    ...
                                                    value="<?= $contact['sci_country_code']; ?>-<?= $contact['sci_mobile']; ?>" placeholder="Mobile No." required="">
                                            ...
                                            <div class="form-group col-lg-4">
                                                ...
                                                <input readonly type="text"
                                                    class="form-control form-control-lg form-control-solid px-2"
                                                    id="email" name="email" value="<?= $contact['sci_email']; ?>"
                                            ...
                                            <div class="form-group col-lg-4">
                                                ...
                                                <input readonly type="text" id="gender" name="gender"
                                                    class="form-control form-control-solid" value="<?php if ($other['gender'] == 0) echo 'Male'; ?><?php if ($other['gender'] == 1) echo 'Female'; ?><?php if ($other['gender'] == 2) echo 'Other'; ?>" placeholder="Gender"
                                                    required="">

                                            </div>
                                            <div class="form-group col-lg-4">
                                                <label for="dob">Date Of Birth:</label>
                                                <input readonly type="text" id="dob" name="dob"
                                                    class="form-control form-control-solid" placeholder="<?= $other['dob']; ?>"
                                                    required="">

                                            </div>
                                            <div class="form-group col-lg-4">
                                                <label for="cat">Category:</label>
                                                <input readonly type="text" id="cat" name="cat"
                                                    class="form-control form-control-solid" placeholder="Category" value="<?= getCasteById($other['caste_id']) ?>"
                                                    required="">

                                            </div>
                                            <div class="form-group col-lg-4">
                                                <label for="religion">Religions:</label>
                                                <input readonly type="text" id="religion" name="religion"
                                                    class="form-control form-control-solid" placeholder="Religions" value="<?= getReligionById($other['religion_id']); ?>"
                                                    required="">

                                            </div>
                                            <div class="form-group col-lg-4">
                                                <label for="religion">Aadhar No.:</label>
                                                <input disabled type="text" id="aadhar" name="aadhar"
                                                    class="form-control form-control-solid" value="<?= $other['aadhar']; ?>"
                                                    required="">
                                    ...
                                    <div class="col-lg-12 row mx-0 order-md-2">
                                        <div class="form-group col-lg-3">
                                            ...
                                            <input readonly type="text" id="sid" name="sid"
                                                class="form-control form-control-solid" value="<?php
                                                            echo $sid;
                                                        ?>" placeholder="SID"
                                                required="">
                                        ...
                                        <div class="form-group col-lg-3">
                                                ...
                                                <input readonly type="text" id="program" name="program"
                                                    class="form-control form-control-solid" placeholder="Program name" value="<?= getProgram($sidInfo['program_id']); ?>"
                                                    required="">
                                    ...
                                    <div class="row mx-0">
                                        ...
                                        <div class="form-group col-lg-3">
                                            ...
                                            <input readonly type="text" id="father_name" name="father_name"
                                                class="form-control form-control-solid" value="<?= $parentDetail['father_name']; ?>" placeholder="Father Name">

                                        </div>
                                        <div class="form-group col-lg-3">
                                            <label for="mother_name">Mother Name:</label>
                                            <input readonly type="text" id="mother_name" name="mother_name"
                                                class="form-control form-control-solid" value="<?= $parentDetail['mother_name']; ?>" placeholder="Father Name">

                                        </div>
                                        <div class="form-group col-lg-3">
                                            <label for="parent_mobile">Parent's Mobile:</label>
                                            <input readonly type="text" id="parent_mobile" name="parent_mobile"
                                                class="form-control form-control-solid" value="<?= $parentDetail['parent_mobile']; ?>" placeholder="Parent's Mobile">

                                        </div>
                                        <div class="form-group col-lg-3">
                                            <label for="parent_email">Parent's Email:</label>
                                            <input readonly type="text" id="parent_email" name="parent_email"
                                                class="form-control form-control-solid" value="<?= $parentDetail['parent_email']; ?>" placeholder="Parent's Mobile">

                                        </div>
                                        <div class="form-group col-lg-3">
                                            <label for="father_income">Father's Annual Income:</label>
                                            <input readonly type="text" id="father_income" name="father_income"
                                                class="form-control form-control-solid" value="<?= $parentDetail['father_income']; ?>"
                                                placeholder="Father's Annual Income">

                                        </div>
                                        <div class="form-group col-lg-3">
                                            <label for="mother_income">Mother's Annual Income:</label>
                                            <input readonly type="text" id="mother_income" name="mother_income"
                                                class="form-control form-control-solid" value="<?= $parentDetail['mother_income']; ?>"
                                                placeholder="Mother's Annual Income">

                                        </div>
                                        <div class="form-group col-lg-3">
                                            <label for="landline">Landline No.:</label>
                                            <input readonly type="text" id="landline" name="landline"
                                                class="form-control form-control-solid" value="<?= $other['landline']; ?>" placeholder="Landline No.">
                                    ...
                                    <div class="row mx-0 my-2">
                                        <div class="col-lg-12">
                                            <h3 class="font-size-h6 mb-5">
                                                <?php if (count($address) < 2) {echo 'Permanent and Current';} else { if ($i == 1) echo 'Permanent'; else echo 'Current'; } ?>
                                                Address:
                                            </h3>
                                        </div>
                                    </div>
                                    <div class="row mx-0">
                                        <div class="col-lg-5">
                                            <div class="form-group mb-4">
                                                ...
                                                <input readonly type="text"
                                                    ...
                                                    placeholder="House or Flat No, Street Name/Village Name" />
                                            </div>
                                        </div>
                                        <div class="col-lg-2">
                                            <div class="form-group mb-4">
                                        ...
                                        <div class="col-lg-2">
                                            ...
                                            <div class="form-group mb-4">
                                                ...
                                                <input readonly type="text" id="district" name="district"
                                                    value="<?= $row['district']; ?>"
                                                    class="form-control form-control-solid form-control-lg"
                                                    ...
                                                    <tbody>
                                                        ...
                                                        <tr>
                                                            ...
                                                            <td>
                                                                ...
                                                                <?php if ($row['grade_type'] == 1) echo "Grade";else echo "%"; ?>)
                                                            </td>
                                                        </tr>
                                                        <?php endforeach; ?>
                                                    </tbody>
                                        ...
                                        <div class="col-lg-3 my-3">
                                            ...
                                            <div class="card">
                                                ...
                                                <iframe class="card-img"
                                                    src="https://docs.google.com/gview?url=<?= $url.substr($student['sd_url'],'1') ?>&embedded=true"></iframe>
                                                <?php else : ?>
