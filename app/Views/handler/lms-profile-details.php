...
<div class="wizard wizard-6 d-flex flex-column flex-lg-row flex-column-fluid" id="kt_wizard">
    ...
    <div class="wizard-content d-flex flex-column w-100 py-1 py-lg-2">
                ...
                <div class="wizard-steps mx-auto d-flex flex-row flex-md-row">
                    ...
                    <div class="wizard-step flex-grow-1 flex-basis-0">
                        <div class="wizard-wrapper pr-lg-7 pr-2">
                            ...
                            <div class="wizard-label mr-3">
                                <h3 class="wizard-title"><a href="<?= base_url('handler/process-application/'.$lid.'/'.$sid.'/profile-detail') ?>">Personal Details</a></h3>
                            </div>
                            <span class="svg-icon">
                    ...
                    <div class="wizard-step flex-grow-1 flex-basis-0">
                        <div class="wizard-wrapper pr-lg-7 pr-2">
                            ...
                            <div class="wizard-label mr-3">
                                <h3 class="wizard-title" ><a href="<?= base_url('handler/process-application/'.$lid.'/'.$sid.'/parent-detail') ?>" >Parent's Details</a></h3>
                    ...
                    <div class="wizard-step flex-grow-1 flex-basis-0">
                        <div class="wizard-wrapper">
                            ...
                            <div class="wizard-label">
                                <h3 class="wizard-title"><a href="<?= base_url('handler/process-application/'.$lid.'/'.$sid.'/address-detail') ?>">Residential Address</a></h3>
        ...
        <?= $this->include("handler/form-".$step); ?>
