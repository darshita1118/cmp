        ...
        <div class="topbar">
            <div class="dropdown">
                ...
                <div class="topbar-item" data-toggle="dropdown" data-offset="10px,0px" aria-expanded="true">
                    <div onclick="document.querySelector('#kt_quick_user_toggle').click()"
                ...
                <div class="dropdown-menu p-0 m-0 dropdown-menu-anim-up dropdown-menu-sm dropdown-menu-right" style="">
                    ...
                    <ul class="navi navi-hover py-4">
                        ...
                        <li class="navi-item active">
                            <a href="<?=base_url('handler/logout');?>" class="navi-link">
...
<div id="kt_quick_user" class="offcanvas offcanvas-right p-10">
	...
	<!--end::Header-->
	<!--begin::Content-->
	<div class="offcanvas-content pr-5 mr-n5 scroll ps ps--active-y" style="height: 363px; overflow: hidden;">
		<!--begin::Header-->
		<div class="d-flex align-items-center mt-5">

			<div class="d-flex flex-column">
				<a href="<?= base_url('handler') ?>" class="font-weight-bold font-size-h5 text-dark-75 text-hover-primary">
					<?= session()->get('name') ?? '' ?>
				</a>
				...
				<div class="navi mt-2">
					...
					<a href="<?= base_url('handler/logout') ?>" class="btn btn-sm btn-light-primary font-weight-bolder py-2 px-5">Logout</a>
				</div>
			</div>
		</div>
		<!--end::Header-->
		...
		<div>
			<!--begin:Heading-->
			<h5 class="mb-5">Stacks</h5>
			<!--end:Heading-->
			<?php $i = 0; $totalLeads = 0;
			foreach ($sideMenuStatusReports as $reportStatus) : $totalLeads += $reportStatus['total_leads']; ?>
				<!--begin::Item-->
				<div class="d-flex align-items-center bg-light-<?= $svgClass[$i] ?> rounded p-5 gutter-b">
					<?= $svgs[$i++]; ?>
					<div class="d-flex flex-column flex-grow-1 mr-2">
						<a href="<?= base_url('handler/lead-status-report/' . $reportStatus['id']) ?>" class="font-weight-normal text-dark-75 text-hover-primary font-size-lg mb-1"><?= $reportStatus['name'] ?? 'New Opportunity' ?></a>

					</div>
					<span class="font-weight-bolder text-warning py-1 font-size-lg">
						<?= $reportStatus['total_leads'] ?? '0' ?>
					</span>
				</div>
				<!--end::Item-->
				<?php if ($reportStatus['type'] == 2) : $i = $i == 3 ? 0 : $i;
					...
					<div class="d-flex align-items-center bg-light-<?= $svgClass[$i] ?> rounded p-5 gutter-b">
						<?= $svgs[$i++]; ?>
						<div class="d-flex flex-column flex-grow-1 mr-2">
							<a href="<?= base_url('handler/lead-status-report/' . $reportStatus['id'] . '/today') ?>" class="font-weight-normal text-dark-75 text-hover-primary font-size-lg mb-1">Today <?= $reportStatus['name'] ?? 'New Opportunity' ?></a>
					...
					<div class="d-flex align-items-center bg-light-<?= $svgClass[$i] ?> rounded p-5 gutter-b">
						<?= $svgs[$i++]; ?>
						<div class="d-flex flex-column flex-grow-1 mr-2">
							<a href="<?= base_url('handler/lead-status-report/' . $reportStatus['id'] . '/overdue') ?>" class="font-weight-normal text-dark-75 text-hover-primary font-size-lg mb-1">Overdue <?= $reportStatus['name'] ?? 'New Opportunity' ?></a>
			...
			<div class="d-flex align-items-center bg-light-<?= $svgClass[$i] ?> rounded p-5 gutter-b">
				<?= $svgs[$i]; ?>
				<div class="d-flex flex-column flex-grow-1 mr-2">
					<a href="<?= base_url('handler') ?>" class="font-weight-normal text-dark-75 text-hover-primary font-size-lg mb-1"><?= 'Total Leads' ?></a>
		...
		<div class="ps__rail-y" style="top: 0px; height: 363px; right: 0px;">
			<div class="ps__thumb-y" tabindex="0" style="top: 0px; height: 148px;"></div>
		</div>
	</div>
	<!--end::Content-->
</div>