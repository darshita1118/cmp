...
<div class="px-4 py-2">
    <form id="kt_forms" action="<?= base_url('handler/profile-step-action/'.$lid.'/'.$sid) ?>" novalidate="novalidate" method="POST">
        ...
        <div class="pb-5" >
            ...
            foreach ($levels as $lev) : $i = $lev['el_id']; ?>
                ...
                <div class="mb-4 d-flex mt-8">
                    ...
                    <?php if (count($levels) == $i) { ?>
                        <input class="m-1" id="awaited" name="awaited" type="checkbox" onclick="Rawaited('<?=$i?>');">Result Awaited
                    <?php } ?>
                </div>
                <?php
        ...
        <div class="d-flex justify-content-between border-top mt-5 pt-5">
            <div class="mr-2">
                <a href="<?= base_url('handler/process-application/' . $lid . '/' . $sid . '/profile-detail') ?>" class="btn btn-light-primary font-weight-bolder text-uppercase">Previous</a>
            </div>
            <div>
