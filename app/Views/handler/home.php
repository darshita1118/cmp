                ...
                <div class="col-lg-4">
                    ...
                    <div class="card card-custom card-stretch gutter-b">
                        ...
                        <div class="card-header border-0 pt-5">
                            <h3 class="card-title font-weight-bolder">Task Completed</h3>
                    ...
                    <div class="card card-custom card-stretch gutter-b">
                        ...
                        <div class="card-header border-0 py-5">
                            <h3 class="card-title align-items-start flex-column">
                                <span class="card-label font-weight-bolder text-dark">New Leads</span>
                                    ...
                                    <table class="table table-head-custom table-head-bg table-borderless table-vertical-center">
                                        <thead>
                                            <tr class="text-left text-uppercase">
                                                ...
                                                <th style="min-width: 100px">SID</th>
                                                <th style="min-width: 100px">Reg.Date</th>
            ...
            <div class="row">
                ...
                <div class="col-lg-6 col-xxl-4">
                    ...
                    <div class="card card-custom card-stretch gutter-b">
                        ...
                        <div class="card-header border-0 pt-5">
                            <h3 class="card-title align-items-start flex-column">
                                <span class="card-label font-weight-bolder text-dark">Lead status 20-2021</span>
                        ...
                        <div class="card-body pt-8">
                            ...
                            <div class="d-flex align-items-center mb-10">
                                ...
                                <div class="d-flex flex-column font-weight-bold">
                                    <a href="#" class="text-dark text-hover-primary mb-1 font-size-lg">Total application on desk</a>
                                </div>
                                <!--end::Text-->
                            </div>
                            <!--end::Item-->
                            ...
                            <div class="d-flex align-items-center mb-10">
                                ...
                                <!--begin::Text-->
                                <div class="d-flex flex-column font-weight-bold">
                                    <a href="#" class="text-dark-75 text-hover-primary mb-1 font-size-lg">Application on finance desk</a>
                                    <span class="text-muted">Enrollment Pending</span>
                                </div>
                                <!--end::Text-->
                            </div>
                            <!--end::Item-->
                            ...
                            <div class="d-flex align-items-center mb-10">
                                ...
                                <!--begin::Text-->
                                <div class="d-flex flex-column font-weight-bold">
                                    <a href="#" class="text-dark text-hover-primary mb-1 font-size-lg">Application on senior desk</a>
                                    <span class="text-muted">Documents not completed</span>
                                </div>
                                <!--end::Text-->
                            </div>
                            <!--end::Item-->
                            ...
                            <div class="d-flex align-items-center mb-10">
                                ...
                                <!--begin::Text-->
                                <div class="d-flex flex-column font-weight-bold">
                                    <a href="#" class="text-dark text-hover-primary mb-1 font-size-lg">Application re-verfication</a>
                                    <span class="text-muted">Student Left university during admission process</span>
                                </div>
                                <!--end::Text-->
                            </div>
                            <!--end::Item-->
                ...
                <div class="col-lg-6 col-xxl-4">
                    ...
                    <div class="card card-custom card-stretch gutter-b">
                        ...
                        <div class="card-header border-0 pt-5">
                            <h3 class="card-title align-items-start flex-column">
                                <span class="card-label font-weight-bolder text-dark">Tasks Overview 20-2021</span>
                        ...
                        <div class="card-body pt-8">
                            ...
                            <div class="d-flex align-items-center mb-10">
                                ...
                                <!--begin::Text-->
                                <div class="d-flex flex-column font-weight-bold">
                                    <a href="#" class="text-dark text-hover-primary mb-1 font-size-lg">Total Enrolled</a>
                                    <span class="text-muted">Enrollment Genrated</span>
                                </div>
                                <!--end::Text-->
                            </div>
                            <!--end::Item-->
                            ...
                            <div class="d-flex align-items-center mb-10">
                                ...
                                <!--begin::Text-->
                                <div class="d-flex flex-column font-weight-bold">
                                    <a href="#" class="text-dark-75 text-hover-primary mb-1 font-size-lg">Total Pending</a>
                                    <span class="text-muted">Enrollment Pending</span>
                                </div>
                                <!--end::Text-->
                            </div>
                            ...
                            <div class="d-flex align-items-center mb-10">
                                ...
                                <!--begin::Text-->
                                <div class="d-flex flex-column font-weight-bold">
                                    <a href="#" class="text-dark text-hover-primary mb-1 font-size-lg">Total Rejected</a>
                                    <span class="text-muted">Documents not completed</span>
                                </div>
                                <!--end::Text-->
                            </div>
                            ...
                            <div class="d-flex align-items-center mb-10">
                                ...
                                <!--begin::Text-->
                                <div class="d-flex flex-column font-weight-bold">
                                    <a href="#" class="text-dark text-hover-primary mb-1 font-size-lg">Total Spam</a>
                                    <span class="text-muted">Student Left university during admission process</span>
                                </div>
                                <!--end::Text-->
                            </div>
                ...
                <div class="col-lg-6 col-xxl-4">
                    ...
                    <div class="card card-custom card-stretch gutter-b">
                        ...
                        <div class="card-header border-0 py-5">
                            <h3 class="card-title align-items-start flex-column">
                                <span class="card-label font-weight-bolder text-dark">Enrolled in programs</span>
                                ...
                                <div class="table-responsive">
                                    <table class="table table-head-custom table-head-bg table-borderless table-vertical-center">
                                        <thead>
                                            <tr class="text-left text-uppercase">
                                                <th style="min-width: 250px" class="pl-7">
                                                    <span class="text-dark-75">Program Name</span>
                                                </th>
                                                <th style="min-width: 100px">Total Enrolled</th>
