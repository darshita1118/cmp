...
?>
<!--begin::Form-->
<form class="px-1" novalidate="novalidate" id="kt_form" method="post" action="<?= base_url('handler/edit-profile-step-action/'.$lid.'/'.$sid) ?>">
    <?= csrf_field() ?>
    <!--begin: Wizard Step 2-->
    <div class="pb-5" >
        <!--begin::Input-->
    ...
    <div class="d-flex justify-content-between pt-7">
        <div class="mr-2">
            <a href="<?= base_url('handler/edit-application-form/'.$lid.'/'.$sid.'/profile-detail') ?>"
        ...
        <div>
            ...
            <a href="<?= base_url('handler/edit-application-form/'.$lid.'/'.$sid.'/address-detail') ?>"class="btn btn-light-primary font-weight-bolder text-uppercase">NEXT</a>
        </div>
    </div>
    <!--end: Wizard Actions-->
</form>
