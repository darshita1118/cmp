...
<div class="pb-5">
    <!--begin::Form-->
    <form class="px-1" method="post" id="personal" action="<?= base_url('handler/edit-profile-step-action/'.$lid.'/'.$sid) ?>">
        <?= csrf_field() ?>
        <!--begin::Title-->
        <div class="row">
        	<div class="col-xl-2">
        ...
        <div class="row">
            ...
            <div class="col-lg-3">
                <div class="form-group">
                    <label data-toggle="tooltip" data-theme="dark" data-html="true" title="<p>Please enter your 12 digit Aadhar Number.</p>">Student's
                        Aadhar No <i class="fa fa-question-circle"></i><span style="color:red">*</span></label>
                    <div class="input-group">
                        <input type="text" id="aadhar" class="form-control form-control-solid form-control-lg" name="aadhar" onkeypress="return onlyNumberKey(event)" maxlength="12" value="<?= old('aadhar') ?? ($studentOther['aadhar'] ?? ($leadInfo['aadhar'] ?? '')); ?>" placeholder="Student's Aadhar No. ">
                    </div>
                    <span class="form-text text-danger"><?= \Config\Services::validation()->showError('aadhar'); ?></span>
                </div>
            </div>
            <div class="col-lg-3">
                <div class="form-group">
        ...
        <div class="d-flex justify-content-between pt-7">
            ...
            <div>
                ...
                <a href="<?= base_url('handler/edit-application-form/'.$lid.'/'.$sid.'/parent-detail') ?>"
...
<script>
    ...
    ?>
        ...
        //getNature('<?= (old('program')??($studentInfo['program_id']  ?? ( $leadInfo['lead_programe'] ??''))) ?>', '<?= old("nature")??($studentInfo['si_course_nature']??'') ?>', '<?= $default ?>')
