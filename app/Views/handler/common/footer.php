...
<div id="footer" class="app-footer m-0">
	&copy; 2024 CMP Admin - All Rights Reserved
</div>
</div>
<a href="javascript:;" class="btn btn-icon btn-circle btn-theme btn-scroll-to-top" data-toggle="scroll-to-top"><i class="fa fa-angle-up"></i></a>

<!-- <script src="<?= base_url('assets/js/rocket-loader.min.js') ?>" type="text/javascript"></script> -->
<script src="<?= base_url('assets/js/beacon.min.js') ?>" type="text/javascript"></script>
<script src="<?= base_url('assets/js/vendor.min.js') ?>" type="text/javascript"></script>
<script src="<?= base_url('assets/js/app.min.js') ?>" type="text/javascript"></script>
<!--html data table scripts-->
