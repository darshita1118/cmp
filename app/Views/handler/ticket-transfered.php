                            ...
                            <table class="table table-head-custom table-head-bg table-borderless table-vertical-center">
                                ...
                                <tbody>
                                    ...
                                    <?php foreach ($tickets as $ticket) { ?>
                                        <tr class="border-bottom tr-hover read" onclick="window.location.href='<?= base_url('handler/tickets/' . $ticket['token_id'] . '?step=transfered') ?>'">
                                            ...
                                            <td>
                                                <span class="text-dark-75 d-block font-size-lg"><?= time_elapsed_string($ticket['created_at']) ?></span>
