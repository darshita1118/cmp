                            ...
                            <div class="card-body px-5">
                                ...
                                <div class="navi navi-hover navi-active navi-link-rounded navi-bold navi-icon-center navi-light-icon">
                                    ...
                                    <div class="navi-item my-2">
                                        <a href="<?= base_url('admin/tickets?step=create-ticket') ?>" class="px-0 navi-link <?= (@$_GET['step'] == 'create-ticket') ? 'active' : null ?>">
                                    ...
                                    <!--begin:Item-->
                                    <div class="navi-item my-2">
                                        <a href="<?= base_url('admin/tickets?step=inbox') ?>" class="px-0 navi-link <?php if (!isset($_GET['step']) || @$_GET['step'] == 'inbox') echo 'active'; ?>">
                                            <span class="navi-icon mr-4">
                                                <span class="svg-icon svg-icon-lg">
                                                    <!--begin::Svg Icon | path:assets/media/svg/icons/Communication/Mail-heart.svg-->
                                                    <svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" width="24px" height="24px" viewBox="0 0 24 24" version="1.1">
                                    ...
                                    <!--begin:Item-->
                                    <div class="navi-item my-2">
                                        <a href="<?= base_url('admin/tickets?step=answered') ?>" class="px-0 navi-link <?php if (@$_GET['step'] == 'answered') echo 'active'; ?>">
                                            <span class="navi-icon mr-4">
                                                <span class="svg-icon svg-icon-lg">
                                                    <!--begin::Svg Icon | path:assets/media/svg/icons/Communication/Mail-heart.svg-->
                                                    <svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" width="24px" height="24px" viewBox="0 0 24 24" version="1.1">
                                    ...
                                    <!--begin:Item-->
                                    <div class="navi-item my-2">
                                        <a href="<?= base_url('admin/tickets?step=transfered') ?>" class="px-0 navi-link <?php if (@$_GET['step'] == 'transfered') echo 'active'; ?>">
                                            <span class="navi-icon mr-4">
                                                <span class="svg-icon svg-icon-lg">
                                                    <!--begin::Svg Icon | path:assets/media/svg/icons/Communication/Mail-heart.svg-->
                                                    <svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" width="24px" height="24px" viewBox="0 0 24 24" version="1.1">
                                    ...
                                    <!--begin:Item-->
                                    <div class="navi-item my-2">
                                        <a href="<?= base_url('admin/tickets?step=closed') ?>" class="px-0 navi-link <?php if (@$_GET['step'] == 'closed') echo 'active'; ?>">
                                            <span class="navi-icon mr-4">
                                                <span class="svg-icon svg-icon-lg">
                                                    <!--begin::Svg Icon | path:assets/media/svg/icons/Communication/Mail-heart.svg-->
                                                    <svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" width="24px" height="24px" viewBox="0 0 24 24" version="1.1">
                                    ...
                                    <!--begin:Item-->
                                    <div class="navi-item my-2">
                                        <a href="<?= base_url('admin/tickets?step=sent') ?>" class="px-0 navi-link <?php if (@$_GET['step'] == 'sent') echo 'active'; ?>">
                                            <span class="navi-icon mr-4">
                                                <span class="svg-icon svg-icon-lg">
                                    ...
                                    <!--begin:Item-->
                                    <div class="navi-item my-2">
                                        <a href="<?= base_url('admin/tickets?step=team') ?>" class="px-0 navi-link <?php if (@$_GET['step'] == 'team') echo 'active'; ?>">
                                            <span class="navi-icon mr-4">
                                                <span class="svg-icon svg-icon-lg">
                                                    <!--begin::Svg Icon | path:assets/media/svg/icons/Communication/Sending.svg-->
                                            ...
                                            <span class="navi-text font-weight-bolder font-size-lg">Team Tickets</span>
                                            <span class="navi-label">
                                                <span class="label label-rounded label-light-success font-weight-bolder"><?= @$team ?></span>
                                            </span>
                                        </a>
                                    </div>
                                    <!--end:Item-->
