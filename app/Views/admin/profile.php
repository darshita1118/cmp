                                    ...
                                    <div class="pt-3 pb-3">
                                        <?php if ($sidData = checkSidCreated($profileDetail['lid'])) :  ?>
                                            ...
                                            <?php if($sidData['form_step'] <= 6): ?>
                                                <a href="<?= base_url('admin/process-application/'.$profileDetail['lid'].'/'.$sidData['sid']) ?>" target="_blank" class="btn btn-outline-success btn-sm mx-auto my-2">Proceed Application</a>
                                                
                                            <?php else: ?>
                                                <a href="<?= base_url('admin/process-application/'.$profileDetail['lid'].'/'.$sidData['sid']) ?>" class="btn btn-outline-success btn-sm mx-auto my-2">Application Under Process</a>
                                            <?php endif; ?>
                                        <?php else: ?>
                                            <a href="<?= base_url('admin/apply-now/'.$profileDetail['lid']) ?>" class="btn btn-outline-success btn-sm mx-auto my-2" target="_blank">Generate Sid</a>
                                        <?php endif; ?>
                                        ...
                                        <div class="timeline timeline-3">
                                            <div class="timeline-items">
                                                <?php foreach($remarks as $rmk): 
                                                    ...
                                                    if($rmk['handler_id'] == session('unique_id')):
                                                        $handlername = 'You';
                                                    else:
            ...
            <div class="card card-custom">
                ...
                <div class="card-footer align-items-center">
                    ...
                    <form action="" method="post">
                        <?= csrf_field() ?>
                        <input name='remarkMessage' required class="form-control border-0 p-0" rows="2" placeholder="Type a message"/>
