...
<div class="pb-5">
    <!--begin::Form-->
    <form class="px-1" method="post" id="personal" action="<?= base_url('admin/edit-profile-step-action/'.$lid.'/'.$sid) ?>">
        <?= csrf_field() ?>
        <!--begin::Title-->
        <div class="row">
        	<div class="col-xl-2">
        ...
        <div class="d-flex justify-content-between pt-7">
            ...
            <div>
                ...
                <a href="<?= base_url('admin/edit-application-form/'.$lid.'/'.$sid.'/parent-detail') ?>"
