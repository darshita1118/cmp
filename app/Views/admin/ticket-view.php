...
<div class="w-100">
        ...
        <div class="col-xl-12 col-lg-12">
            <div class="align-items-center flex-wrap py-3 px-0">
                ...
                <div class="align-items-center py-3 d-flex">
                    <a href="<?= base_url('admin/tickets?step=' . $_GET['step']) ?>" class="align-items-left btn btn-white px-2 mr-2" style="align-self:start;box-shadow: 0px 0px 2px 0px rgb(6 6 6 / 47%), 0px 0px 7px #060606;"><i class="flaticon2-arrow-down font-size-h4 text-primary pl-1" style="transform: rotate(90deg);"></i></a>
    ...
    <div class="row mx-0">
        <div class="col-lg-3">
            <div class="">
                    ...
                    <div class="card-body px-2 py-2">
                        ...
                        <?php if ($_GET['step'] == 'transfered') { ?>
                            ...
                            if ($_GET['step'] != 'sent') { 
                                if ($_GET['step'] == 'team') { ?>
                                    <div class="border-bottom py-2">
                                        <p class="mb-1">Receiving Type / Receiver</p>
                                        <?php $drModel = new ApplicationModel('lms_users_'.session('year'), 'lu_id','reg_setting_db');
                                            $desk = $drModel->select(['user_name'])->where('lu_id', $ticket['tc_department'])->first();
                                        ?>
                                        <b class="font-size-h5"><?= (isset($ticket['type'])) ? (($ticket['type'] == 0) ? 'To' : 'CC') : 'Transfer' ?> / <?=ucwords($desk['user_name'])?></b>
                                    </div>
                                <?php } else { ?>
                                    <div class="border-bottom py-2">
                ...
                <?php if ($_GET['step'] == 'inbox' || ($_GET['step'] == 'team' && ($ticket['action_status'] == 1 || $ticket['action_status'] == 3)) || ($_GET['step'] == 'sent' && $ticket['action_status'] == 4)) : ?>
        ...
        <div class="col-lg-9">
            ...
            <?php if (isset($replies)) : foreach ($replies as $reply) :
                   if($reply['user_type']==2):
                    $aiModel = new ApplicationModel('admin_info', 'aid','sso_'.session('suffix'));
                    ...
                    $luModel = new ApplicationModel('lms_users_'.session('year'), 'lu_id','reg_setting_db');
    ...
    <?php if (isset($ticket['type'])) : ?>
        <?php if ($_GET['step'] == 'inbox' || ($_GET['step'] == 'team' && ($ticket['action_status'] == 1 || $ticket['action_status'] == 3))) : ?>
