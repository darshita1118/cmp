                                ...
                                <div class="row align-items-center">
                                        ...
                                        <div class="align-items-center form-group">
                                            ...
                                            <select name="tl[]" id="tl" data-live-search="true" class="form-control selectpicker" multiple>
                                                <?php foreach($teamLeaders??[] as $leader): ?>
                                                    <option value="<?= $leader['lu_id'] ?>"><?= $leader['user_name'] ?></option>
                                                <?php endforeach; ?>
                                            </select>
                                        </div>
                                    </div>
                                    ...
                                    <div class="col-lg-3 col-xl-3">
                                        <div class="align-items-center form-group">
                                            ...
                                            <div class="m-auto ">
                                                ...
                                                <select name="source[]" data-live-search="true" id="source" class="form-control selectpicker"
                                                    multiple>
                                    ...
                                    */ ?>
                                    <div class="col-lg-3 col-xl-3">
                                        <div class=" align-items-center form-group">
                                            <div class="m-auto ">
                                                ...
                                                <select name="program[]" data-live-search="true" id="program" class="form-control selectpicker"
                                                    multiple>
                                                    <?php foreach($programs as $program): ?>
                                                        <option value="<?= $program['sc_id'] ?>"><?= $program['course_name'] ?></option>
                                                    <?php endforeach; ?>
                                    ...
                                    <div class="col-lg-3 col-xl-3 form-group">
                                        <label for="">&nbsp;</label>
                                        <button type="submit"
                                            class="form-control btn btn-light-primary font-weight-bold">Search</button>
                                ...
                                <div class="row mx-0">
                                            ...
                                            <div class="card-body p-0" style="position: relative;">
                                                <div class="d-flex align-items-center justify-content-between px-3 py-2 flex-grow-1 "
                                                    ...
                                                    <div class="d-flex flex-column text-right">
                                                        <span
                                                            class="text-dark-75 font-weight-bolder font-size-h3"><?= $totalLeads ?></span>
                                    ...
                                    <div class="col-xl-3">
                                        ...
                                        <div class="card card-custom card-stretch gutter-b"
                                            ...
                                            <div class="card-body p-0" style="position: relative;">
                                                <div
                                                    class="d-flex align-items-center justify-content-between px-3 py-2 flex-grow-1 ">
                                                    ...
                                                    <div class="d-flex flex-column text-right">
                                                        <span
                                                            class="text-dark-75 font-weight-bolder font-size-h3"><?= $totalAllocated ?></span>
                                        ...
                                        <div class="card card-custom card-stretch gutter-b"
                                            ...
                                            <div class="card-body p-0" style="position: relative;">
                                                <div
                                                        ...
                                                        <span class="symbol-label">
                                                            <span class="svg-icon svg-icon-xl svg-icon-primary">
                                                                ...
                                                                <svg xmlns="http://www.w3.org/2000/svg"
                                                                    ...
                                                                    <g stroke="none" stroke-width="1" fill="none"
                                                                        fill-rule="evenodd">
                                                                        <rect opacity="0.300000012" x="0" y="0"
                                                    ...
                                                    <div class="d-flex flex-column text-right">
                                                        <span
                                                            class="text-dark-75 font-weight-bolder font-size-h3"><?= $totalUnallocated ?></span>
                                        ...
                                        <div class="card card-custom card-stretch gutter-b"
                                            ...
                                            <div class="card-body p-0" style="position: relative;">
                                                <div
                                                    ...
                                                    <div class="d-flex flex-column text-right">
                                                        <span
                                                            class="text-dark-75 font-weight-bolder font-size-h3"><?= $totalRegistered ?></span>
                                                        <span class="text-muted font-weight-bold mt-2">Registered SID
                                                        </span>
                                                    </div>
                                                </div>
                ...
                <div class="col-lg-12">
                    <div class="card card-custom" data-card="true" id="kt_card_3">
                        ...
                        <div class="card-body px-2">
                            <form action="" method="get" class=" px-3 py-3">
                                <div class="row align-items-center">
                                    <div class="col-lg-2 col-xl-3">
                                        <div class="input-icon form-group">
                                            <label for="from">From</label>
                                            <input type="text" name="from" id="from" class="form-control datep" value=""
                                                autocomplete="off" placeholder="dd-mm-yyyy">
                                        </div>
                                    </div>
                                    <div class="col-lg-2 col-xl-3">
                                        <div class="input-icon form-group">
                                            <label for="to">To</label>
                                            <input type="text" name="to" id="to" class="form-control datep" value=""
                                                autocomplete="off" placeholder="dd-mm-yyyy">
                                        </div>
                                    </div>
                                    <div class="col-lg-3 col-xl-3">
                            ...
                            <div class="mb-3">
                                <div class="row mx-0">
                                    <?php $chartData = []; foreach($dataAdmissionStatus as $admssion): ?>
                                    <div class="col-xl-2">
                                        <!--begin::Stats Widget 10-->
                                        <div class="card card-custom card-stretch gutter-b"
                                            style="border: 1px solid <?= $admssion['color'] ?>;">
                                            <!--begin::Body-->
                                            <div class="card-body p-0">
                                                <div class="align-items-center justify-content-between px-3 py-2 flex-grow-1 "
                                                    style="">

                                                    <div class="d-flex flex-column text-center">
                                                        <span
                                                            class="text-dark-75 font-weight-bolder font-size-h3"><?php $key = array_search($admssion['id'], $sqlAdmissionStatus, true); ?><?php $stats = ($key!==false)?$admissionStatus[$key]['sid']:'0';
                                                            echo $stats; ?></span>
                                                        <span
                                                            class="text-muted font-weight-bold mt-2 text-center"><?= $admssion['name'] ?></span>
                                                    </div>
                                                </div>
                            ...
                            <?php /*
                                ...
                                am5.ready(function() {
                                    ...
                                    series.data.setAll(<?= json_encode($chartData) ?>);
                                ...
                                */ ?>
                                ...
                                am5.ready(function() {
                                    ...
                                    xAxis.data.setAll(<?= json_encode($chartData) ?>);
                                    series.data.setAll(<?= json_encode($chartData) ?>);
