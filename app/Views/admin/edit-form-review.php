    ...
    <div class="form" id="review_form">
        ...
        <div class="pb-5">
            <div class="d-flex">
                ...
                <div class="ml-auto" style="cursor: pointer;"><a href="<?= base_url('admin/edit-application-form/' . $lid . '/' . $sid . '/profile-detail') ?>"><i class="flaticon-edit icon-lg text-primary"></i></a></div>
            </div>
            ...
            <div class="d-flex">
                ...
                <div class="ml-auto" style="cursor: pointer;"><a href="<?= base_url('admin/edit-application-form/' . $lid . '/' . $sid . '/parent-detail') ?>"><i class="flaticon-edit icon-lg text-primary"></i></a></div>
            </div>
            ...
            foreach ($address as $row) : ?>
                <div class="d-flex">
                    ...
                    <div class="ml-auto" style="cursor: pointer;"><a href="<?= base_url('admin/edit-application-form/' . $lid . '/' . $sid . '/address-detail') ?>"><i class="flaticon-edit icon-lg text-primary"></i></a></div>
                </div>
            ...
            <div class="d-flex">
                ...
                <div class="ml-auto" style="cursor: pointer;"><a href="<?= base_url('admin/edit-application-form/' . $lid . '/' . $sid . '/academic-detail') ?>"><i class="flaticon-edit icon-lg text-primary"></i></a></div>
            </div>
            ...
            <div class="d-flex">
                ...
                <div class="ml-auto" style="cursor: pointer;"><a href="<?= base_url('admin/edit-application-form/' . $lid . '/' . $sid . '/document-upload') ?>"><i class="flaticon-edit icon-lg text-primary"></i></a></div>
            </div>
            ...
            <hr class="my-3" style="border-top: 1px solid #000;">
            <div class="form-group mb-4 fv-plugins-icon-container">
                <form id='final_form' method="post" action="<?= base_url('admin/edit-profile-step-action/'.$lid.'/'.$sid) ?>">
                    <?= csrf_field() ?>
                <div class="checkbox-inline my-3">
                    <label class="checkbox checkbox-lg">
                        ...
                        <span></span>
                        After Form submit has been cloased and You connot edit any information.
                    </label>
                </div>
                </form>
            </div>
        ...
        <div class="d-flex justify-content-between border-top mt-5 pt-5">
            <div class="mr-2">
                <a href="<?= base_url('admin/edit-application-form/' . $lid . '/' . $sid . '/upload-document') ?>" class="btn btn-light-primary font-weight-bolder text-uppercase">Previous</a>
            </div>
            <div>
