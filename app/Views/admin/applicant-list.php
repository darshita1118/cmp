            ...
            <tbody>
                ...
                foreach ($leads as $lead) : ?>
                    <tr class="odd gradeX">
                        ...
                        <td nowrap="">
                            <a href="<?= base_url('admin/process-application/' . $lead['lead_id'] . '/' . $lead['sid']) ?>" class="btn btn-warning btn-icon btn-sm" data-bs-toggle="tooltip" title="Proceed Application">
