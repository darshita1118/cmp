            ...
            <div class="card card-custom gutter-b">
                <div class="card-header flex-wrap py-3">
                    <div class="card-title">
                        <h3 class="card-label">Edit Application Form(Reopen) [Totals: <?= $total_leads??0 ?>]
                ...
                <div class="card-body">
                    ...
                    <div class="row mx-2 align-items-center">
					    ...
					    <td><?= date('d/m/Y H:i:s', strtotime($lead['sl_created_at'])) ?></td>
                                            <td class="" >
                                                <a href="<?= base_url('admin/edit-application-form/' . $lead['lead_id'].'/'.$lead['sid']) ?>" class="btn btn-sm btn-clean" title="Edit Application Form">
