...
<div class="pb-5">
    ...
    <form class="px-1" method="post" id="personal" action="<?= base_url('admin/profile-step-action/' . $lid . '/' . $sid) ?>">
        ...
        <div class="row">
            ...
            <div class="col-xl-3">
                ...
                <div class="form-group">
                    ...
                    <select id="discipline" name="discipline" onchange="change(this.value)" class="form-control form-control-solid form-control-lg">
                        <option value="">Select</option>
        ...
        <div class="row">
            <div class="col-lg-4">
                <div class="form-group">
                    ...
                    <input type="text" id="firstname" class="form-control form-control-solid form-control-lg" name="firstname" value="<?= old('firstname') ?? ($studentInfo['si_first_name'] ?? ($leadInfo['lead_first_name'] ?? '')); ?>" placeholder="First Name" />
            ...
            <div class="col-lg-4">
                <div class="form-group">
                    <label for="middlename" data-toggle="tooltip" data-theme="dark" data-html="true" title="<p>Please enter your middle name exactly as stated in official documents such as your 10th Marksheet.</p>">Middle
                        Name <i class="fa fa-question-circle"></i></label>
                    <input type="text" id="middlename" class="form-control form-control-solid form-control-lg" name="middlename" value="<?= old('middlename') ?? ($studentInfo['si_middle_name'] ?? ($leadInfo['lead_middle_name'] ?? '')); ?>" placeholder="Middle Name" />
            ...
            <div class="col-lg-4">
                <div class="form-group">
                    <label for="lastname" data-toggle="tooltip" data-theme="dark" data-html="true" title="<p>Please enter your last name exactly as stated in official documents such as your 10th Marksheet.</p>">Last
                        Name <i class="fa fa-question-circle"></i></label>
                    <input type="text" id="lastname" class="form-control form-control-solid form-control-lg" name="lastname" value="<?= old('lastname') ?? ($studentInfo['si_last_name'] ?? ($leadInfo['lead_last_name'] ?? '')); ?>" placeholder="Last Name" />
        ...
        <div class="row">
            ...
            <div class="col-lg-3">
                <div class="form-group">
                    <label for="dob" data-toggle="tooltip" data-theme="dark" data-html="true" title="<p>Please enter your date of birth exactly as stated in official documents such as your 10th marksheet.</p>">Date
                        of Birth <i class="fa fa-question-circle"></i></label>
                    <div class="input-group">
                        <input type="text" class="form-control form-control-solid form-control-lg" name="dob" value="<?= old('dob') ??  ($studentOther['dob'] ?? ''); ?>" max="2008-05-31" placeholder="Select date" id="dob" />
        ...
        <div class="row">
            <div class="col-lg-3">
                <div class="form-group">
                    <label for="email" data-toggle="tooltip" data-theme="dark" data-html="true" title="<p>Please enter your personal email id. Further communication with the university will be done on this email id.</p>">Student's
                        Email <i class="fa fa-question-circle"></i></label>
                    <input type="text" id="email" class="form-control form-control-solid form-control-lg" value="<?= old('email') ?? ($studentContact['sci_email'] ?? ($leadInfo['lead_email'] ?? '')); ?>" placeholder="Student's Email" disabled />
                    <span class="form-text text-danger"><?= \Config\Services::validation()->showError('email'); ?></span>
                </div>
            </div>
            <div class="col-lg-2">
                <div class="form-group">
                    <label for="student_mobile" data-toggle="tooltip" data-theme="dark" data-html="true" title="<p>Please enter your personal mobile number. Your Unique Student ID and Password will be sent to this number via a text message. Kindly ensure that the number is working and is available at all times.</p>">Student's
                        Mobile No <i class="fa fa-question-circle"></i></label>
                    <div class="input-group">
                        <div class="input-group-prepend">
                            <span class="input-group-text"><?= $studentContact['sci_country_code'] ?? ($leadInfo['lead_country_code'] ?? '') ?></span>
                        </div>
                        <input type="text" class="form-control form-control-solid form-control-lg" value="<?= old('student_mobile') ?? ($studentContact['sci_mobile'] ?? ($leadInfo['lead_mobile'] ?? '')); ?>" placeholder="Student's Mobile No. " disabled>
                    </div>
                    <span class="form-text text-danger"><?= \Config\Services::validation()->showError('student_mobile'); ?></span>
                </div>
            ...
            <div class="col-lg-2">
                <div class="form-group">
                    <label data-toggle="tooltip" data-theme="dark" data-html="true" title="" data-original-title="<p>Kindly mention your residence landline number, if available.</p>">Landline
                        No. <i class="fa fa-question-circle"></i></label>
                    <input type="text" class="form-control form-control-solid form-control-lg" name="landline" value="<?= old('landline') ?? ($studentOther['landline'] ?? ''); ?>" placeholder="Landline No.">
        ...
        <div class="d-flex justify-content-between pt-7">
            ...
            <div>
                ...
                <a href="<?= base_url('admin/process-application/' . $lid . '/' . $sid . '/parent-detail') ?>" class="btn btn-light-primary font-weight-bolder text-uppercase">
                    NEXT</a>
            </div>
