				...
				<div class="navbar-nav">
					...
					<div class="navbar-item dropdown">
						...
						<div class="dropdown-menu">
							<a href="<?= base_url('admin/applicant-list') ?>" class="dropdown-item">Process Application</a>
							<a href="<?= base_url('admin/application-form-reopen') ?>" class="dropdown-item">Reopened Application Form</a>
						</div>
					</div>
					<div class="navbar-item dropdown">
						<a href="#" class="navbar-link dropdown-toggle d-flex align-items-center" data-bs-toggle="dropdown">
						...
						<div class="dropdown-menu">
							<a href="<?= base_url('admin/reports') ?>" class="dropdown-item">Report Stats</a>
							<a href="<?= base_url('admin/report/created-sid') ?>" class="dropdown-item"> Created Sid List</a>
							<a href="<?= base_url('admin/report/registration') ?>" class="dropdown-item"> Registration List</a>
							<a href="<?= base_url('admin/report/admission-done') ?>" class="dropdown-item"> Admission Done List</a>
							<a href="<?= base_url('admin/student-learning-report') ?>" class="dropdown-item"> Student Learning</a>
							<a href="<?= base_url('admin/reportall') ?>" class="dropdown-item"> counselor Work Report</a>
						</div>
					</div>
				</div>
			</div>
