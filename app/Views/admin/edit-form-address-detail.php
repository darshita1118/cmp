...
?>
<!--begin::Form-->
<form class="px-1" method="post" action="<?= base_url('admin/edit-profile-step-action/' . $lid . '/' . $sid) ?>">
    <!--begin: Wizard Step 3-->
    <div class="pb-5" >
        <!--begin::Input-->
        <?= csrf_field() ?>
    ...
    <div class="d-flex justify-content-between pt-3">
        <div class="mr-2">
            <a href="<?= base_url('admin/edit-application-form/' . $lid . '/' . $sid . '/parent-detail') ?>" class="btn btn-light-primary font-weight-bolder text-uppercase">
                Previous</a>
        </div>
        <div>
