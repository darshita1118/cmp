            ...
            <tbody>
                ...
                foreach ($leads as $lead) : ?>
                    <tr class="odd gradeX">
                        ...
                        <td nowrap="">
                            <a href="<?= base_url('admin/lead-profile/' . $lead['lid']) ?>" class="btn btn-icon btn-sm btn-primary me-1" data-bs-toggle="tooltip" title="Edit"><i class="fa fa-pen"></i></a>
                            <a href="<?= base_url('admin/delete/lead/' . $lead['lid']) ?>" class="btn btn-icon btn-sm btn-danger" data-bs-toggle="tooltip" title="Delete"><i class="fa fa-right-from-bracket"></i>
                            </a>
                        </td>
                    </tr>
                <?php $count++;
