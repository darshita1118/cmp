    ...
    <div class="form" id="review_form">
        ...
        <div class="pb-5">
            <div class="d-flex">
                ...
                <div class="ml-auto" style="cursor: pointer;"><a href="<?= base_url('admin/process-application/' . $lid . '/' . $sid . '/profile-detail') ?>"><i class="flaticon-edit icon-lg text-primary"></i></a></div>
            </div>
            ...
            <div class="d-flex">
                ...
                <div class="ml-auto" style="cursor: pointer;"><a href="<?= base_url('admin/process-application/' . $lid . '/' . $sid . '/parent-detail') ?>"><i class="flaticon-edit icon-lg text-primary"></i></a></div>
            </div>
            ...
            foreach ($address as $row) : ?>
                <div class="d-flex">
                    ...
                    <div class="ml-auto" style="cursor: pointer;"><a href="<?= base_url('admin/process-application/' . $lid . '/' . $sid . '/address-detail') ?>"><i class="flaticon-edit icon-lg text-primary"></i></a></div>
                </div>
            ...
            <div class="d-flex">
                ...
                <div class="ml-auto" style="cursor: pointer;"><a href="<?= base_url('admin/process-application/' . $lid . '/' . $sid . '/academic-detail') ?>"><i class="flaticon-edit icon-lg text-primary"></i></a></div>
            </div>
            ...
            <div class="d-flex">
                ...
                <div class="ml-auto" style="cursor: pointer;"><a href="<?= base_url('admin/process-application/' . $lid . '/' . $sid . '/document-upload') ?>"><i class="flaticon-edit icon-lg text-primary"></i></a></div>
            </div>
            ...
            <hr class="my-3" style="border-top: 1px solid #000;">
            <div class="form-group mb-4 fv-plugins-icon-container">
                <form id='final_form' method="post" action="<?= base_url('admin/profile-step-action/' . $lid . '/' . $sid) ?>">
                    <?= csrf_field() ?>
        ...
        <div class="d-flex justify-content-between border-top mt-5 pt-5">
            <div class="mr-2">
                <a href="<?= base_url('admin/process-application/' . $lid . '/' . $sid . '/document-upload') ?>" class="btn btn-light-primary font-weight-bolder text-uppercase">Previous</a>
            </div>
            <div>
