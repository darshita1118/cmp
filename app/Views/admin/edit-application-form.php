...
<div class="content d-flex flex-column flex-column-fluid" id="kt_content">
    ...
    <div class="d-flex flex-column-fluid">
        ...
        <div class="container">
            ...
            <?php if($editRemark): ?>
            <div class="alert alert-custom alert-notice alert-light-info py-2 fade show" role="alert">
                <div class="alert-icon"><i class="flaticon-info"></i></div>
                <div class="alert-text font-size-h6"><?= $editRemark['sds_remark'] ?></div>
                            ...
                            <div class="wizard-steps flex-row">
                                ...
                                <div class="wizard-step wizard_clip_active" data-wizard-state="current">
                                    <div class="wizard-label">
                                        <h3 class="wizard-title d-flex">1.<span class="d-none d-lg-flex">&nbsp;<a style="color:#fff" href="<?= base_url('admin/edit-application-form/'.$lid.'/'.$sid.'/profile-detail') ?>">Profile Details</a></span></h3>
                                    </div>
                                ...
                                <div class="wizard-step wizard_clip_unprogress">
                                    <div class="wizard-label">
                                        <h3 class="wizard-title d-flex">2.<span class="d-none d-lg-flex">&nbsp;<a style="color:#000" href="<?= base_url('admin/edit-application-form/'.$lid.'/'.$sid.'/academic-detail') ?>">Academic Details</a></span></h3>
                                    </div>
                                ...
                                <div class="wizard-step wizard_clip_unprogress">
                                    <div class="wizard-label">
                                        <h3 class="wizard-title d-flex">3.<span class="d-none d-lg-flex">&nbsp;<a style="color:#000" href="<?= base_url('admin/edit-application-form/'.$lid.'/'.$sid.'/document-upload') ?>">Documents Upload</a></span></h3>
                                    </div>
                                ...
                                <div class="wizard-step wizard_clip_unprogress">
                                    <div class="wizard-label">
                                        <h3 class="wizard-title d-flex">4.<span class="d-none d-lg-flex">&nbsp;<a style="color:#000" href="<?= base_url('admin/edit-application-form/'.$lid.'/'.$sid.'/review') ?>">Review and Submit</a></span></h3>
                                    </div>
