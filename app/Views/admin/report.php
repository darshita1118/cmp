                ...
                <div class="col-lg-12">
                    <div class="card card-custom" data-card="true" id="kt_card_3">
                        ...
                        <div class="card-body px-2">
                            ...
                            <div class="mb-3">
                                <div class="row mx-0">
                                <div class="col-xl-4" onclick="window.location.href='<?= base_url('admin/report/created-sid') ?>'">
                                    ...
                                    <div class="col-xl-4" onclick="window.location.href='<?= base_url('admin/report/registration') ?>'">
                                    ...
                                    <div class="col-xl-4" onclick="window.location.href='<?= base_url('admin/report/admission-done') ?>'">
